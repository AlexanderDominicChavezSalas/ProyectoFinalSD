...
public class Bank_C implements RemoteInterface {
	...
	public void crearCuenta (String nombre) {
        ...
        {
			//
			ficheroList = new FileWriter("D:/Compartida/ProyectoFinal/Bank_C/src/main/java/com/soap/ws/Archivos/ListaDeCuentas.txt",true);
			pwList = new PrintWriter(ficheroList);
			pwList.print(user.getNombre() + " | ");
			pwList.println(user.getN_cuenta());

            fichero = new FileWriter("D:/Compartida/ProyectoFinal/Bank_C/src/main/java/com/soap/ws/Archivos/" + 
